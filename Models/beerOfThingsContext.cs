...
namespace beerOfThings.Models
{
    public partial class beerOfThingsContext : DbContext
    {
        ...
        public virtual DbSet<OptimalTemperature> OptimalTemperatures { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<OptimalTemperature>(entity =>
            {
                entity.ToTable("OptimalTemperature");
            ...
            modelBuilder.Entity<Stage>(entity =>
            {
                ...
                entity.Property(e => e.OptimalTemperatureId).HasColumnName("optimalTemperatureId");

                entity.HasOne(d => d.OptimalTemperature)
                    .WithMany(p => p.Stages)
                    .HasForeignKey(d => d.OptimalTemperatureId)
                    .HasConstraintName("FK_Stage_OptimalTemperature");
            });
